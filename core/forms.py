...
class PostForm(forms.ModelForm):
    ...
    PostImageWebLink = forms.CharField(required=False, widget=forms.widgets.TextInput(attrs={'placeholder': 'input image from the web instead', 'class': 'form-control'}))
...
class ServiceForm(forms.ModelForm):
    ...
    description = forms.CharField(required=True,
                               widget=forms.widgets.Textarea(attrs={'id':'', 'placeholder': 'Service description', 'class': 'form-control mb-4'}))
